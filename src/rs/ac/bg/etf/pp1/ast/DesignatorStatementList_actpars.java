...
public class DesignatorStatementList_actpars extends DesignatorStatementList {

    private ActParsOpt ActParsOpt;

    public DesignatorStatementList_actpars (ActParsOpt ActParsOpt) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementList_actpars(\n");
