...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(CondList_error CondList_error) { visit(); }
    ...
    public void visit(ActParsList_par ActParsList_par) { visit(); }
    public void visit(DesignatorMeth DesignatorMeth) { visit(); }
    ...
    public void visit(Statement_retexpr Statement_retexpr) { visit(); }
