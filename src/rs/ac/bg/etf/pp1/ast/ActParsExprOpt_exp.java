...
public class ActParsExprOpt_exp extends ActParsExprOpt {

    private ActParsExprOpt ActParsExprOpt;
    private Expr Expr;

    public ActParsExprOpt_exp (ActParsExprOpt ActParsExprOpt, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsExprOpt_exp(\n");
